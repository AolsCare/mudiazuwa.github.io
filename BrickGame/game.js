...
new PadHandler(this.paddle, this,this.gamestate, this.ball)
    }
    ...
    start(){
        ...
        this.bricks= buildLevel(this, this.levels[this.currentLevel], this.gameWidth)
...
document.getElementById("pause_img").style.zIndex=10
    ...
    update(deltaTime){
        ...
        if(this.gamestate===GAMESTATE.PAUSED||this.gamestate===GAMESTATE.PAUSE||this.gamestate===GAMESTATE.MENU||this.gamestate===GAMESTATE.GAMEOVER)return;
    ...
    draw(ctx){
        ...
        if(this.gamestate==GAMESTATE.MENU){
            ...
            ctx.fillStyle="white";
            ctx.textAlign="center";
            ctx.fillText("Press Spacebar or Tap the Screen to Start", this.gameWidth/2, this.gameHeight/2)
